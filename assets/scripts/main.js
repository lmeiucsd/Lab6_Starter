...
function initFormHandler() {
  ...
  const submitReference = document.querySelector('button[type="submit"]');
  ...
  let clearReference = document.querySelector('button[class="danger"]');
  ...
  clearReference.addEventListener("click", () => {
    ...
    let mainReference = document.querySelector('main');
    while (mainReference.hasChildNodes()) {
      mainReference.removeChild(mainReference.firstChild);
    }
  });
